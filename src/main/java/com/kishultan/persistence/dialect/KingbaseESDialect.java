...
/**
 * KingbaseES 数据库方言实现（人大金仓）
 * KingbaseES 高度兼容 PostgreSQL
 */
public class KingbaseESDialect implements DatabaseDialect {
    ...
    public String limit(int offset, int limit) {
        // KingbaseES 兼容 PostgreSQL 的 LIMIT/OFFSET 语法
