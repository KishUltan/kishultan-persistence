 ...
 * TDSQL 高度兼容 MySQL 协议
 */
public class TDSQLDialect implements DatabaseDialect {
    ...
    public String limit(int offset, int limit) {
        // TDSQL 兼容 MySQL 的 LIMIT/OFFSET 语法
