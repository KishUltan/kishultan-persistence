...
/**
 * PolarDB 数据库方言实现（阿里）
 * PolarDB 兼容 MySQL、PostgreSQL 和 Oracle 协议
 */
public class PolarDBDialect implements DatabaseDialect {
    ...
    public String limit(int offset, int limit) {
        // PolarDB (MySQL 模式) 支持 LIMIT/OFFSET 语法
